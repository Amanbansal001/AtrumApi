...
const ProductBidsController = {
  ...
  show(req, res, next) {
    ...
    module.get_product_bids_id(Number(req.params.id));
  },
  ...
  update(req, res, next) {
    ...
    module.update_product_bids(req);
  },


};

module.exports = ProductBidsController;