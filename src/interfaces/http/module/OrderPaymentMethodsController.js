...
const OrderPaymentMethodsController = {
  get router() {
    const router = Router();
  ...
  index(req, res, next) {
    ...
    module.get_order_payment_methods(req);
  },
  ...
  show(req, res, next) {
    ...
    module.get_order_payment_methods_id(Number(req.params.id));
  },
  ...
  create(req, res, next) {
    ...
    module.add_order_payment_methods(req);
  },
  ...
  update(req, res, next) {
    ...
    module.update_order_payment_methods(req);
  },


};

module.exports = OrderPaymentMethodsController;
