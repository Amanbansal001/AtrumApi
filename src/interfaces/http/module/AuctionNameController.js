...
const AuctionNameController = {
  ...
  show(req, res, next) {
    ...
    module.get_auction_names_id(Number(req.params.id));
  },
...
module.exports = AuctionNameController;
