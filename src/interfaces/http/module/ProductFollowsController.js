...
const ProductFollowsController = {
  get router() {
    const router = Router();
  ...
  index(req, res, next) {
    ...
    module.get_product_follows(req);
  },
  ...
  show(req, res, next) {
    ...
    module.get_product_follows_id(Number(req.params.id));
  },
  ...
  create(req, res, next) {
    ...
    module.add_product_follows(req);
  },
  ...
  update(req, res, next) {
    ...
    module.update_product_follows(req);
  },


};

module.exports = ProductFollowsController;