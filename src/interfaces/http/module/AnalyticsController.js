...
const AnalyticsController = {
  get router() {
    ...
    router.put('/:id', inject('module'), this.update);
  ...
  show(req, res, next) {
    ...
    module.get_analytics_id(Number(req.params.id));
  },
