...
const ProductSharesController = {
  ...
  show(req, res, next) {
    ...
    module.get_product_shares_id(Number(req.params.id));
  },
  ...
  update(req, res, next) {
    ...
    module.update_product_shares(req);
  },
