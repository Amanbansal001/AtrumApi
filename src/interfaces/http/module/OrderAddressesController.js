...
const OrderAddressesController = {
  get router() {
    const router = Router();
  ...
  index(req, res, next) {
    ...
    module.get_order_addresses(req);
  },
  ...
  show(req, res, next) {
    ...
    module.get_order_addresses_id(Number(req.params.id));
  },
  ...
  create(req, res, next) {
    ...
    module.add_order_addresses(req);
  },
  ...
  update(req, res, next) {
    ...
    module.update_order_addresses(req);
  },


};

module.exports = OrderAddressesController;
