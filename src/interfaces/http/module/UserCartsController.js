...
const UserCartsController = {
  ...
  show(req, res, next) {
    ...
    module.get_user_carts_id(Number(req.params.id));
  },
  ...
  update(req, res, next) {
    ...
    module.update_user_carts(req);
  },


};

module.exports = UserCartsController;