...
const UserFollowsController = {
  ...
  show(req, res, next) {
    ...
    module.get_user_follows_id(Number(req.params.id));
  },
  ...
  update(req, res, next) {
    ...
    module.update_user_follows(req);
  },
