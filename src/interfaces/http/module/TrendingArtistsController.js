...
const TrendingArtistsController = {
  get router() {
    const router = Router();
  ...
  index(req, res, next) {
    ...
    module.get_trending_artists(req);
  },
  ...
  show(req, res, next) {
    ...
    module.get_trending_artists_id(Number(req.params.id));
  },
  ...
  create(req, res, next) {
    ...
    module.add_trending_artists(req);
  },
  ...
  update(req, res, next) {
    ...
    module.update_trending_artists(req);
  },


};

module.exports = TrendingArtistsController;