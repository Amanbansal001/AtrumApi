...
const ProductsController = {
  get router() {
    ...
    router.get('/all', inject('module'), this.indexAll);
  ...
  show(req, res, next) {
    ...
    module.get_products_id(req,Number(req.params.id));
  },
