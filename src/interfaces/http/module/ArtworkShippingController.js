...
const ArtworkShippingController = {
  get router() {
    const router = Router();
  ...
  index(req, res, next) {
    ...
    module.get_artwork_shippings(req);
  },
  ...
  show(req, res, next) {
    ...
    module.get_artwork_shippings_id(req,Number(req.params.id));
  },
  ...
  create(req, res, next) {
    ...
    module.add_artwork_shippings(req);
  },
...
module.exports = ArtworkShippingController;